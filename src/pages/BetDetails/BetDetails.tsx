...
export default function BetDetails({ onCancel }: BetDetailsProps) {
  ...
  if (loading) {
    return <div className="min-h-screen bg-[#1C1C27] text-white p-4 flex items-center justify-center">Loading...</div>
  }

  if (!eventData) {
    return <div className="min-h-screen bg-[#1C1C27] text-white p-4 flex items-center justify-center">Event not found</div>
  }
